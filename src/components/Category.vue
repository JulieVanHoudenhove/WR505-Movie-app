...
<template>
  <div v-if="category" class="flex flex-col items-center gap-7 rounded-[15px] max-w-[600px] p-5 border border-[rgba(0,0,0,0.14)] shadow-[0_0_10px_rgba(0,0,0,0.2)]">
    ...
    <div class="flex justify-between gap-10">
      <button class=" w-fit min-h-[42px] bg-[#D64343] text-white rounded-md border border-[#D64343] hover:bg-transparent hover:text-[#D64343] px-5" @click="toggleForm = true" v-if="roles === 'ROLE_ADMIN'" :category="category">Modifier</button>
